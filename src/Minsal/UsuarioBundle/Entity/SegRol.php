...
class SegRol
{
     ...
     * Add segUsuarioid
     *
     * @param \Minsal\UsuarioBundle\Entity\SegUsuario $segUsuarioid
     *
     * @return SegRol
     */
    public function addSegUsuarioid(\Minsal\UsuarioBundle\Entity\SegUsuario $segUsuarioid)
    {
     ...
     * @param \Minsal\UsuarioBundle\Entity\SegUsuario $segUsuarioid
     */
    public function removeSegUsuarioid(\Minsal\UsuarioBundle\Entity\SegUsuario $segUsuarioid)
    {
