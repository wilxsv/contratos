...
{	
		...
		public function analizadorProrrogaAction($prorroga)
		{
			...
			$dql2 = "SELECT mc.id, mc.numeroModalidad, c.id as contrato, c.numeroContrato, p.codigoProducto, p.nombreProducto, c.montoContrato, pc.cantidad, pc.precioUnitario, p.id, pr.nombreProveedor, IDENTITY (p.establecimientoProducto) AS establecimientoProductoP, pr.id AS idProveedor
