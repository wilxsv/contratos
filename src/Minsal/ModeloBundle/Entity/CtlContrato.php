 ...
 * CtlContrato
 *
 * @ORM\Table(name="ctl_contrato", indexes={@ORM\Index(name="fki_establecimiento_contrato", columns={"contrato_establecimiento"}), @ORM\Index(name="fki_modalidad_compra", columns={"numero_modalidad_compra"}), @ORM\Index(name="fki_proveedor_contrato", columns={"contrato_proveedor"}), @ORM\Index(name="fki_proveedor", columns={"contrato_proveedor"})})
 * @ORM\Entity
 */
class CtlContrato
{
